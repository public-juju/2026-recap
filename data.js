...
const INITIAL_DATA = {
  dramas: [
    { id: "d1", title: "프로보노", status: "완료" },
    { id: "d2", title: "기묘한 이야기 시즌5", status: "완료" },
    { id: "d3", title: "자백의 대가", status: "완료" },
    { id: "d4", title: "당신이 죽였다", status: "완료" },
    { id: "d5", title: "언더커버 미쓰홍", status: "완료" },
    { id: "d6", title: "브리저튼 시즌4", status: "완료" },
    { id: "d7", title: "샬럿 왕비 : 브리저튼 외전", status: "완료" },
    { id: "d8", title: "레이디 두아", status: "완료" },
    { id: "d9", title: "프렌즈 시즌1", status: "완료" },
    { id: "d10", title: "사랑의 이해", status: "완료" },
    { id: "d11", title: "은중과 상연", status: "완료" },
    { id: "d12", title: "월간남친", status: "완료" },
    { id: "d13", title: "닥터신", status: "완료" },
    { id: "d14", title: "샤이닝", status: "완료" },
    { id: "d15", title: "유미의 세포들3", status: "완료" },
    { id: "d16", title: "허수아비", status: "완료" },
    { id: "d17", title: "멋진 신세계", status: "완료" },
    { id: "d18", title: "프렌즈 시즌2", status: "완료" },
    { id: "d19", title: "옥씨부인전", status: "완료" },
    { id: "d20", title: "백번의추억", status: "완료" },
    { id: "d21", title: "맨 끝줄 소년", status: "완료" },
    { id: "d22", title: "결혼의 완성", status: "보는중" },
    { id: "d23", title: "더 글로리", status: "보는중" },
    { id: "d24", title: "동궁", status: "보는중" },
    { id: "d25", title: "메이드 인 코리아", status: "중도하차" },
    { id: "d26", title: "은애하는 도적님아", status: "중도하차" },
    { id: "d27", title: "은밀한 감사", status: "중도하차" },
    { id: "d28", title: "취사병 전설이 되다", status: "중도하차" },
    { id: "d29", title: "신입사원 강회장", status: "중도하차" },
    { id: "d30", title: "김부장", status: "중도하차" }
  ],

  shows: [
    { id: "s1", title: "흑백요리사2", status: "완료" },
    { id: "s2", title: "냉장고를 부탁해", status: "완료" },
    { id: "s3", title: "풍향고 시즌2", status: "완료" },
    { id: "s4", title: "스카이스크레이퍼 라이브 : 초고층 빌딩을 오르다", status: "완료" },
    { id: "s5", title: "제프리 앱스타인 : 괴물이 된 억만장자", status: "완료" },
    { id: "s6", title: "철학자의 요리", status: "완료" },
    { id: "s7", title: "더 코리안 셰프", status: "완료" },
    { id: "s8", title: "이서진의 달라달라", status: "완료" },
    { id: "s9", title: "유퀴즈온더블록", status: "완료" },
    { id: "s10", title: "공양간의 셰프들", status: "완료" },
    { id: "s11", title: "다큐3일", status: "완료" },
    { id: "s12", title: "마이클잭슨 재판 : 평결", status: "완료" },
    { id: "s13", title: "콩콩팜팜", status: "보는중" },
    { id: "s14", title: "언더커버 셰프", status: "보는중" },
    { id: "s15", title: "모태솔로지만 연애는 하고싶어2", status: "보는중" },
    { id: "s16", title: "스트릿 레스토랑 파이터", status: "보는중" }
  ],
